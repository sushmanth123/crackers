				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="kandukuripavan2@gmail.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/Ecommerce-master/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/Ecommerece-master/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/Ecommerece-master/cancel.php"/>
